...
Nesta primeira lição, você aprenderá mais sobre algumas das funcionalidades que o <a href="https://github.com/microsoft/MixedRealityToolkit-Unity" target="_blank">MRTK (Kit de Ferramentas de Realidade Misturada)</a> tem a oferecer, iniciará seu primeiro aplicativo do HoloLens 2 e o implantará no dispositivo.

## <a name="objectives"></a>Objetivos

* Configure o Unity para o desenvolvimento no HoloLens.
* Importe ativos e configure a cena.
