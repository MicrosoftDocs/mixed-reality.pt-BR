...
Você não tem um dispositivo de realidade misturada? Você pode instalar o [HoloLens (1º gen) emulador](using-the-hololens-emulator.md) para testar algumas funcionalidades de aplicativos de realidade misturada sem um HoloLens. Você também pode usar o [simulador do Windows Mixed Reality](using-the-windows-mixed-reality-simulator.md) para testar seus aplicativos de realidade misturada fones imersivos em exposição.

> [!NOTE]
> Mais orientações específicas para o emulador 2 HoloLens [em breve](index.md#news-and-notes).
...
Para começar com o HoloLens (1º gen) emulador, consulte [usando o emulador do HoloLens](using-the-hololens-emulator.md).

> [!NOTE]
> Mais orientações específicas para o emulador de 2 HoloLens [em breve](index.md#news-and-notes).
...
* [Arquivo morto de emulador do HoloLens](hololens-emulator-archive.md)
