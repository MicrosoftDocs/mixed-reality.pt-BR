...
# <a name="mr-basics-100-getting-started-with-unity"></a>Noções básicas do Sr 100: Introdução ao Unity
...
<td>Noções básicas do Sr 100: Introdução ao Unity</td><td style="text-align: center;"> ✔️</td><td style="text-align: center;"> ✔️</td>
</tr>
</table>
