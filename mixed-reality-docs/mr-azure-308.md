...
1. <span data-ttu-id="7a7f6-124">O aplicativo de PC Desktop permitirá que o usuário mova um objeto em espaço 2D (X e Y), usando o mouse.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-124">The Desktop PC app will allow the user to move an object in 2D space (X and Y), using the mouse.</span></span>
...
## <a name="before-you-start"></a><span data-ttu-id="7a7f6-154">Antes de começar</span><span class="sxs-lookup"><span data-stu-id="7a7f6-154">Before you start</span></span>
...
## <a name="chapter-3---setup-azure-portal-create-notification-hubs-service"></a><span data-ttu-id="7a7f6-180">Capítulo 3-configurar o portal do Azure: criar serviço de hubs de notificação</span><span class="sxs-lookup"><span data-stu-id="7a7f6-180">Chapter 3 - Setup Azure Portal: create Notification Hubs Service</span></span>
...
4.  <span data-ttu-id="7a7f6-191">Depois de clicar em ***criar***:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-191">Once you have clicked on ***Create***:</span></span>
    ...
    3.  <span data-ttu-id="7a7f6-194">Selecione um **local.**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-194">Select a **Location.**</span></span>
...
5.  <span data-ttu-id="7a7f6-224">Depois de clicar em **criar**, um painel será exibido:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-224">Once you have clicked on **Create**, a panel will appear:</span></span>
    ...
    1. <span data-ttu-id="7a7f6-225">Insira o **nome** desejado para esta instância de serviço (deve estar em letras minúsculas).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-225">Insert your desired **Name** for this service instance (must be all lowercase).</span></span>
...
6.  <span data-ttu-id="7a7f6-317">Depois de clicar em **criar**, preencha o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-317">Once you have clicked on **Create**, fill in the following:</span></span>
    ...
    10. <span data-ttu-id="7a7f6-330">Clique em **Criar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-330">Click **Create**.</span></span>
...
14. <span data-ttu-id="7a7f6-347">A janela **http Put** será exibida, na qual você precisa configurar a função (veja abaixo para obter a imagem).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-347">The **HTTP PUT** window will appear, where you need to configure the function (see below for image).</span></span>
...
18. <span data-ttu-id="7a7f6-363">Com o código em vigor, clique em **salvar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-363">With the code in place, click **Save**.</span></span>
...
5.  <span data-ttu-id="7a7f6-442">Ainda em**configurações de compilação**de **arquivo** > , verifique se:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-442">While still in **File** > **Build Settings**, make sure that:</span></span>
    ...
    1.  <span data-ttu-id="7a7f6-443">O **dispositivo de destino** está definido para **qualquer dispositivo**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-443">**Target Device** is set to **Any Device**</span></span>
...
7.  <span data-ttu-id="7a7f6-459">Nesse painel, algumas configurações precisam ser verificadas:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-459">In this panel, a few settings need to be verified:</span></span>
...
10. <span data-ttu-id="7a7f6-470">Salve sua cena e **arquivo** > de projeto**salvar cena/arquivo** > **salvar projeto**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-470">Save your Scene and Project **File** > **Save Scene / File** > **Save Project**.</span></span>
    ...
    > [!IMPORTANT]
    > <span data-ttu-id="7a7f6-471">Se você quiser ignorar o componente de *configuração do Unity* para este projeto (aplicativo de desktop) e continuar diretamente no código, fique à vontade para baixá-lo [. unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-Desktop.unitypackage), importe-o para seu projeto como um [**pacote personalizado**](https://docs.unity3d.com/Manual/AssetPackages.html)e, em seguida, continue do [capítulo 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-471">If you wish to skip the *Unity Set up* component for this project (Desktop App), and continue straight into code, feel free to [download this .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-Desktop.unitypackage), import it into your project as a [**Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), and then continue from [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span>  <span data-ttu-id="7a7f6-472">Ainda será necessário adicionar os componentes de script.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-472">You will still need to add the script components.</span></span>

## <a name="chapter-8---importing-the-dlls-in-unity"></a><span data-ttu-id="7a7f6-473">Capítulo 8-importando as DLLs no Unity</span><span class="sxs-lookup"><span data-stu-id="7a7f6-473">Chapter 8 - Importing the DLLs in Unity</span></span>

<span data-ttu-id="7a7f6-474">Você usará o armazenamento do Azure para Unity (que, por sua vez, utiliza o SDK do .net para o Azure).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-474">You will be using Azure Storage for Unity (which itself leverages the .Net SDK for Azure).</span></span> <span data-ttu-id="7a7f6-475">Para obter mais informações, siga este [link sobre o armazenamento do Azure para Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-475">For more information follow this [link about Azure Storage for Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span></span>

<span data-ttu-id="7a7f6-476">Atualmente, há um problema conhecido no Unity que exige que os plugins sejam reconfigurados após a importação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-476">There is currently a known issue in Unity which requires plugins to be reconfigured after import.</span></span> <span data-ttu-id="7a7f6-477">Essas etapas (4-7 nesta seção) não serão mais necessárias depois que o bug for resolvido.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-477">These steps (4 - 7 in this section) will no longer be required after the bug has been resolved.</span></span>

<span data-ttu-id="7a7f6-478">Para importar o SDK para seu próprio projeto, certifique-se de ter baixado o [ **. unitypackage**](https://aka.ms/azstorage-unitysdk) mais recente do github.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-478">To import the SDK into your own project, make sure you have downloaded the latest [**.unitypackage**](https://aka.ms/azstorage-unitysdk) from GitHub.</span></span> <span data-ttu-id="7a7f6-479">Em seguida, faça o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-479">Then, do the following:</span></span>

1.  <span data-ttu-id="7a7f6-480">Adicione o **. unitypackage** ao Unity usando a opção de menu **pacote \> personalizado do pacote de \> importação de ativos** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-480">Add the **.unitypackage** to Unity by using the **Assets \> Import Package \> Custom Package** menu option.</span></span>

2.  <span data-ttu-id="7a7f6-481">Na caixa **Importar pacote de Unity** que é exibida, você pode selecionar tudo em \* \**plugin* \> \* armazenamento \* \* \*.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-481">In the **Import Unity Package** box that pops up, you can select everything under \*\**Plugin* \> \*Storage\*\*\*.</span></span>  <span data-ttu-id="7a7f6-482">Desmarque todas as outras opções, pois elas não são necessárias para este curso.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-482">Uncheck everything else, as it is not needed for this course.</span></span>

    ![importar para pacote](images/AzureLabs-Lab8-61.png)

3.  <span data-ttu-id="7a7f6-484">Clique no botão ***importar*** para adicionar os itens ao seu projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-484">Click the ***Import*** button to add the items to your project.</span></span>

4.  <span data-ttu-id="7a7f6-485">Vá para a pasta **armazenamento** em **plug-ins** na exibição do projeto e selecione os seguintes plugins *somente*:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-485">Go to the **Storage** folder under **Plugins** in the Project view and select the following plugins *only*:</span></span>

    -   <span data-ttu-id="7a7f6-486">Microsoft.Data.Edm</span><span class="sxs-lookup"><span data-stu-id="7a7f6-486">Microsoft.Data.Edm</span></span>
    -   <span data-ttu-id="7a7f6-487">Microsoft.Data.OData</span><span class="sxs-lookup"><span data-stu-id="7a7f6-487">Microsoft.Data.OData</span></span>
    -   <span data-ttu-id="7a7f6-488">Microsoft. WindowsAzure. Storage</span><span class="sxs-lookup"><span data-stu-id="7a7f6-488">Microsoft.WindowsAzure.Storage</span></span>
    -   <span data-ttu-id="7a7f6-489">Newtonsoft.Json</span><span class="sxs-lookup"><span data-stu-id="7a7f6-489">Newtonsoft.Json</span></span>
    -   <span data-ttu-id="7a7f6-490">System.Spatial</span><span class="sxs-lookup"><span data-stu-id="7a7f6-490">System.Spatial</span></span>

![desmarcar qualquer plataforma](images/AzureLabs-Lab8-62.png)

5.  <span data-ttu-id="7a7f6-492">Com *esses plugins específicos* selecionados, **desmarque** **qualquer plataforma** e **desmarque** **WSAPlayer** e clique em **aplicar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-492">With *these specific plugins* selected, **uncheck** **Any Platform** and **uncheck** **WSAPlayer** then click **Apply**.</span></span>

    ![aplicar DLLs de plataforma](images/AzureLabs-Lab8-63.png)

    > [!NOTE] 
    > <span data-ttu-id="7a7f6-494">Estamos marcando esses plugins específicos para serem usados apenas no editor do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-494">We are marking these particular plugins to only be used in the Unity Editor.</span></span> <span data-ttu-id="7a7f6-495">Isso ocorre porque há diferentes versões dos mesmos plug-ins na pasta WSA que serão usados depois que o projeto for exportado do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-495">This is because there are different versions of the same plugins in the WSA folder that will be used after the project is exported from Unity.</span></span>

6.  <span data-ttu-id="7a7f6-496">Na pasta plug-in de **armazenamento** , selecione somente:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-496">In the **Storage** plugin folder, select only:</span></span>

    -   <span data-ttu-id="7a7f6-497">Microsoft. Data. Services. Client</span><span class="sxs-lookup"><span data-stu-id="7a7f6-497">Microsoft.Data.Services.Client</span></span>

        ![definir não processar para DLLs](images/AzureLabs-Lab8-64.png)

7.  <span data-ttu-id="7a7f6-499">Marque a caixa **não processar** em **configurações da plataforma** e clique em ***aplicar***.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-499">Check the **Don't Process** box under **Platform Settings** and click ***Apply***.</span></span>

    ![aplicar nenhum processamento](images/AzureLabs-Lab8-65.png)

    > [!NOTE] 
    > <span data-ttu-id="7a7f6-501">Estamos marcando este plug-in "não processar", porque o assembly do Unity Patcher tem dificuldade para processar esse plug-in.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-501">We are marking this plugin "Don't process", because the Unity assembly patcher has difficulty processing this plugin.</span></span> <span data-ttu-id="7a7f6-502">O plug-in ainda funcionará, embora não seja processado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-502">The plugin will still work even though it is not processed.</span></span>

## <a name="chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project"></a><span data-ttu-id="7a7f6-503">Capítulo 9-criar a classe TableToScene no projeto de desktop Unity</span><span class="sxs-lookup"><span data-stu-id="7a7f6-503">Chapter 9 - Create the TableToScene class in the Desktop Unity project</span></span>

<span data-ttu-id="7a7f6-504">Agora você precisa criar os scripts que contêm o código para executar este aplicativo.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-504">You now need to create the scripts containing the code to run this application.</span></span>

<span data-ttu-id="7a7f6-505">O primeiro script que você precisa criar é **TableToScene**, que é responsável por:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-505">The first script you need to create is **TableToScene**, which is responsible for:</span></span>

-   <span data-ttu-id="7a7f6-506">Lendo entidades na tabela do Azure.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-506">Reading entities within the Azure Table.</span></span>
-   <span data-ttu-id="7a7f6-507">Usando os dados da tabela, determine quais objetos gerar e em qual posição.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-507">Using the Table data, determine which objects to spawn, and in which position.</span></span>

<span data-ttu-id="7a7f6-508">O segundo script que você precisa criar é **CloudScene**, que é responsável por:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-508">The second script you need to create is **CloudScene**, which is responsible for:</span></span>

-   <span data-ttu-id="7a7f6-509">Registrando o evento de clique com o botão esquerdo, para permitir que o usuário arraste objetos em volta da cena.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-509">Registering the left-click event, to allow the user to drag objects around the scene.</span></span>
-   <span data-ttu-id="7a7f6-510">Serializar os dados de objeto desta cena do Unity e enviá-los para o Aplicativo de funções do Azure.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-510">Serializing the object data from this Unity scene, and sending it to the Azure Function App.</span></span>

<span data-ttu-id="7a7f6-511">Para criar esta classe:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-511">To create this class:</span></span>

1.  <span data-ttu-id="7a7f6-512">Clique com o botão direito do mouse na pasta de **ativos** localizada no painel projeto, **crie** > a**pasta**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-512">Right-click in the **Asset** Folder located in the Project Panel, **Create** > **Folder**.</span></span> <span data-ttu-id="7a7f6-513">Nomeie a pasta **scripts**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-513">Name the folder **Scripts**.</span></span>

    ![criar pasta de scripts](images/AzureLabs-Lab8-66.png)

    ![criar a pasta de scripts 2](images/AzureLabs-Lab8-67.png)

2.  <span data-ttu-id="7a7f6-516">Clique duas vezes na pasta recém-criada para abri-la.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-516">Double click on the folder just created, to open it.</span></span>

3.  <span data-ttu-id="7a7f6-517">Clique com botão direito dentro de **Scripts** pasta, clique em **Create** >  **C# Script**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-517">Right-click inside the **Scripts** folder, click **Create** > **C# Script**.</span></span> <span data-ttu-id="7a7f6-518">Nomeie o script **TableToScene**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-518">Name the script **TableToScene**.</span></span>

    <span data-ttu-id="7a7f6-519">![novo script](images/AzureLabs-Lab8-68.png)
    ![c# TableToScene renomear](images/AzureLabs-Lab8-69.png)</span><span class="sxs-lookup"><span data-stu-id="7a7f6-519">![new c# script](images/AzureLabs-Lab8-68.png)
![TableToScene rename](images/AzureLabs-Lab8-69.png)</span></span>

4.  <span data-ttu-id="7a7f6-520">Clique duas vezes no script para abri-lo no Visual Studio 2017.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-520">Double-click on the script to open it in Visual Studio 2017.</span></span>

5.  <span data-ttu-id="7a7f6-521">Adicione os seguintes namespaces:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-521">Add the following namespaces:</span></span>
...
6.  <span data-ttu-id="7a7f6-522">Dentro da classe, insira as seguintes variáveis:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-522">Within the class, insert the following variables:</span></span>
    ...
    > [!NOTE] 
    > <span data-ttu-id="7a7f6-523">Substitua o valor **accountName** pelo nome do serviço de armazenamento do Azure e pelo valor de **accountKey** pelo valor de chave encontrado no serviço de armazenamento do Azure, no portal do Azure (consulte a imagem abaixo).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-523">Substitute the **accountName** value with your Azure Storage Service name and **accountKey** value with the key value found in the Azure Storage Service, in the Azure Portal (See Image below).</span></span> 
    >
    > ![buscar chave de conta](images/AzureLabs-Lab8-70.png)

7.  <span data-ttu-id="7a7f6-525">Agora, adicione os métodos **Start ()** e **ativo ()** para inicializar a classe.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-525">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
8.  <span data-ttu-id="7a7f6-526">Dentro da classe **TableToScene** , adicione o método que recuperará os valores da tabela do Azure e use-os para gerar os primitivos apropriados na cena.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-526">Within the **TableToScene** class, add the method that will retrieve the values from the Azure Table and use them to spawn the appropriate primitives in the scene.</span></span>
...
9.  <span data-ttu-id="7a7f6-527">Fora da classe **TableToScene** , você precisa definir a classe usada pelo aplicativo para serializar e desserializar as **entidades de tabela**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-527">Outside the **TableToScene** class, you need to define the class used by the application to serialize and deserialize the **Table Entities**.</span></span>
...
10. <span data-ttu-id="7a7f6-528">Certifique-se de **salvar** antes de voltar para o editor do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-528">Make sure you **Save** before going back to the Unity Editor.</span></span>

11. <span data-ttu-id="7a7f6-529">Clique na **câmera principal** do painel **hierarquia** , para que suas propriedades apareçam no **Inspetor**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-529">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span>

12. <span data-ttu-id="7a7f6-530">Com a pasta **scripts** aberta, selecione o **arquivo script TableToScene** e arraste-o para a **câmera principal**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-530">With the **Scripts** folder open, select the script **TableToScene file** and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="7a7f6-531">O resultado deve ser o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-531">The result should be as below:</span></span>

    ![Adicionar script à câmera principal](images/AzureLabs-Lab8-71.png)

## <a name="chapter-10---create-the-cloudscene-class-in-the-desktop-unity-project"></a><span data-ttu-id="7a7f6-533">Capítulo 10 – criar a classe CloudScene no projeto de desktop Unity</span><span class="sxs-lookup"><span data-stu-id="7a7f6-533">Chapter 10 - Create the CloudScene class in the Desktop Unity Project</span></span>

<span data-ttu-id="7a7f6-534">O segundo script que você precisa criar é **CloudScene**, que é responsável por:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-534">The second script you need to create is **CloudScene**, which is responsible for:</span></span>

-   <span data-ttu-id="7a7f6-535">Registrando o evento de clique com o botão esquerdo, para permitir que o usuário arraste objetos em volta da cena.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-535">Registering the left-click event, to allow the user to drag objects around the scene.</span></span>

-   <span data-ttu-id="7a7f6-536">Serializar os dados de objeto desta cena do Unity e enviá-los para o Aplicativo de funções do Azure.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-536">Serializing the object data from this Unity scene, and sending it to the Azure Function App.</span></span>

<span data-ttu-id="7a7f6-537">Para criar o segundo script:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-537">To create the second script:</span></span>

1.  <span data-ttu-id="7a7f6-538">Clique com o botão direito do mouse na pasta **scripts** , clique em **criar**, **script C\#** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-538">Right-click inside the **Scripts** folder, click **Create**, **C\# Script**.</span></span> <span data-ttu-id="7a7f6-539">Nomeie o script **CloudScene**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-539">Name the script **CloudScene**</span></span>
    
    <span data-ttu-id="7a7f6-540">![novo script](images/AzureLabs-Lab8-72.png)
    ![c# renomear CloudScene](images/AzureLabs-Lab8-73.png)</span><span class="sxs-lookup"><span data-stu-id="7a7f6-540">![new c# script](images/AzureLabs-Lab8-72.png)
![rename CloudScene](images/AzureLabs-Lab8-73.png)</span></span>

2.  <span data-ttu-id="7a7f6-541">Adicione os seguintes namespaces:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-541">Add the following namespaces:</span></span>
...
3.  <span data-ttu-id="7a7f6-542">Insira as seguintes variáveis:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-542">Insert the following variables:</span></span>
...
4.  <span data-ttu-id="7a7f6-543">Substitua o valor **azureFunctionEndpoint** pela URL de aplicativo de funções do Azure encontrada no serviço de aplicativo de funções do Azure, no portal do Azure, conforme mostrado na imagem abaixo:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-543">Substitute the **azureFunctionEndpoint** value with your Azure Function App URL found in the Azure Function App Service, in the Azure Portal, as shown in the image below:</span></span>

    ![Obter URL da função](images/AzureLabs-Lab8-74.png)

5.  <span data-ttu-id="7a7f6-545">Agora, adicione os métodos **Start ()** e **ativo ()** para inicializar a classe.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-545">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
6.  <span data-ttu-id="7a7f6-546">Dentro do método **Update ()** , adicione o seguinte código que irá detectar a entrada do mouse e arrastar, que, por sua vez, moverá Gameobjects na cena.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-546">Within the **Update()** method, add the following code that will detect the mouse input and drag, which will in turn move GameObjects in the scene.</span></span> <span data-ttu-id="7a7f6-547">Se o usuário tiver arrastado e descartado um objeto, ele passará o nome e as coordenadas do objeto para o método **UpdateCloudScene ()** , que chamará o serviço de aplicativo de funções do Azure, que atualizará a tabela do Azure e disparará a notificação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-547">If the user has dragged and dropped an object, it will pass the name and coordinates of the object to the method **UpdateCloudScene()**, which will call the Azure Function App service, which will update the Azure table and trigger the notification.</span></span>
...
7.  <span data-ttu-id="7a7f6-548">Agora, adicione o método **UpdateCloudScene ()** , como abaixo:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-548">Now add the **UpdateCloudScene()** method, as below:</span></span>
...
8.  <span data-ttu-id="7a7f6-549">Salve o código e retorne ao Unity</span><span class="sxs-lookup"><span data-stu-id="7a7f6-549">Save the code and return to Unity</span></span>

9.  <span data-ttu-id="7a7f6-550">Arraste o script **CloudScene** para a **câmera principal**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-550">Drag the **CloudScene** script onto the **Main Camera**.</span></span> 

    1. <span data-ttu-id="7a7f6-551">Clique na **câmera principal** do painel **hierarquia** , para que suas propriedades apareçam no **Inspetor**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-551">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span> 

    2. <span data-ttu-id="7a7f6-552">Com a pasta **scripts** aberta, selecione o script **CloudScene** e arraste-o para a **câmera principal**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-552">With the **Scripts** folder open, select the **CloudScene** script and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="7a7f6-553">O resultado deve ser o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-553">The result should be as below:</span></span>

        > ![Arraste o script de nuvem para a câmera principal](images/AzureLabs-Lab8-75.png)

## <a name="chapter-11---build-the-desktop-project-to-uwp"></a><span data-ttu-id="7a7f6-555">Capítulo 11-criar o projeto de desktop para UWP</span><span class="sxs-lookup"><span data-stu-id="7a7f6-555">Chapter 11 - Build the Desktop Project to UWP</span></span>

<span data-ttu-id="7a7f6-556">Tudo o que é necessário para a seção do Unity deste projeto foi concluído.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-556">Everything needed for the Unity section of this project has now been completed.</span></span>

1.  <span data-ttu-id="7a7f6-557">Navegue até **configurações de compilação** (**configurações de compilação**de**arquivo** > ).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-557">Navigate to **Build Settings** (**File** > **Build Settings**).</span></span>

2.  <span data-ttu-id="7a7f6-558">Na janela **configurações de compilação** , clique em **Compilar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-558">From the **Build Settings** window, click **Build**.</span></span>

    ![Compilar projeto](images/AzureLabs-Lab8-76.png)

3.  <span data-ttu-id="7a7f6-560">Uma janela do **Explorador de arquivos** será Popup, solicitando um local para compilar.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-560">A **File Explorer** window will popup, prompting you for a location to Build.</span></span> <span data-ttu-id="7a7f6-561">Crie uma nova pasta (clicando em **nova pasta** no canto superior esquerdo) e nomeie-a como **Build**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-561">Create a new folder (by clicking **New Folder** in the top-left corner), and name it **BUILDS**.</span></span>

    ![nova pasta para compilação](images/AzureLabs-Lab8-77.png)

    1.  <span data-ttu-id="7a7f6-563">Abra a nova pasta builds e crie outra pasta (usando a **nova pasta** mais uma vez) e nomeie-a **\_NH desktop\_app**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-563">Open the new **BUILDS** folder, and create another folder (using **New Folder** once more), and name it **NH\_Desktop\_App**.</span></span>

        ![nome da pasta NH_Desktop_App](images/AzureLabs-Lab8-78.png)

    2.  <span data-ttu-id="7a7f6-565">Com o **aplicativo\_de\_área de trabalho NH** selecionado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-565">With the **NH\_Desktop\_App** selected.</span></span> <span data-ttu-id="7a7f6-566">Clique em **Selecionar pasta**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-566">click **Select Folder**.</span></span> <span data-ttu-id="7a7f6-567">O projeto levará um minuto ou mais para ser compilado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-567">The project will take a minute or so to build.</span></span>

4.  <span data-ttu-id="7a7f6-568">Após a compilação, o **Explorador de arquivos** aparecerá mostrando o local do novo projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-568">Following build, **File Explorer** will appear showing you the location of your new project.</span></span> <span data-ttu-id="7a7f6-569">No entanto, não é necessário abri-lo, pois você precisa criar o outro projeto do Unity primeiro, nos próximos capítulos.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-569">No need to open it, though, as you need to create the other Unity project first, in the next few Chapters.</span></span>


## <a name="chapter-12---set-up-mixed-reality-unity-project"></a><span data-ttu-id="7a7f6-570">Capítulo 12-configurar o projeto de Unity da realidade misturada</span><span class="sxs-lookup"><span data-stu-id="7a7f6-570">Chapter 12 - Set up Mixed Reality Unity Project</span></span>

<span data-ttu-id="7a7f6-571">A seguir está uma configuração típica para o desenvolvimento com a realidade misturada e, como tal, é um bom modelo para outros projetos.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-571">The following is a typical set up for developing with the mixed reality, and as such, is a good template for other projects.</span></span>

1.  <span data-ttu-id="7a7f6-572">Abra o **Unity** e clique em **novo**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-572">Open **Unity** and click **New**.</span></span>

    ![novo projeto do Unity](images/AzureLabs-Lab8-79.png)

2.  <span data-ttu-id="7a7f6-574">Agora, você precisará fornecer um nome de projeto de Unity, inserir **UnityMRNotifHub**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-574">You will now need to provide a Unity Project name, insert **UnityMRNotifHub**.</span></span> <span data-ttu-id="7a7f6-575">Verifique se o tipo de projeto está definido como **3D**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-575">Make sure the project type is set to **3D**.</span></span> <span data-ttu-id="7a7f6-576">Defina o **local** como algum lugar apropriado para você (Lembre-se de que, mais próximo de diretórios raiz é melhor).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-576">Set the **Location** to somewhere appropriate for you (remember, closer to root directories is better).</span></span> <span data-ttu-id="7a7f6-577">Em seguida, clique em **criar projeto**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-577">Then, click **Create project**.</span></span>

    ![nome UnityMRNotifHub](images/AzureLabs-Lab8-80.png)

3.  <span data-ttu-id="7a7f6-579">Com o Unity Open, vale a pena verificar se o **Editor de script** padrão está definido como **Visual Studio**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-579">With Unity open, it is worth checking the default **Script Editor** is set to **Visual Studio**.</span></span> <span data-ttu-id="7a7f6-580">Vá para **Editar** > **preferências** e, em seguida, na janela novo, navegue até **Ferramentas externas**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-580">Go to **Edit** > **Preferences** and then from the new window, navigate to **External Tools**.</span></span> <span data-ttu-id="7a7f6-581">Altere o **Editor de script externo** para o **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-581">Change **External Script Editor** to **Visual Studio 2017**.</span></span> <span data-ttu-id="7a7f6-582">Feche a janela **preferências** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-582">Close the **Preferences** window.</span></span>

    ![definir editor externo como VS](images/AzureLabs-Lab8-81.png)

4.  <span data-ttu-id="7a7f6-584">Em seguida, vá para **arquivo** > **configurações de compilação** e alterne a plataforma para **plataforma universal do Windows**, clicando no botão **alternar plataforma** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-584">Next, go to **File** > **Build Settings** and switch the platform to **Universal Windows Platform**, by clicking on the **Switch Platform** button.</span></span>

    ![alternar plataformas para UWP](images/AzureLabs-Lab8-82.png)

5.  <span data-ttu-id="7a7f6-586">Vá para **arquivo** > **configurações de compilação** e verifique se:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-586">Go to **File** > **Build Settings** and make sure that:</span></span>

    1.  <span data-ttu-id="7a7f6-587">O **dispositivo de destino** está definido para **qualquer dispositivo**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-587">**Target Device** is set to **Any Device**</span></span>

        > <span data-ttu-id="7a7f6-588">Para o Microsoft HoloLens, defina o **dispositivo de destino** como *HoloLens*.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-588">For the Microsoft HoloLens, set **Target Device** to *HoloLens*.</span></span>

    2.  <span data-ttu-id="7a7f6-589">O **tipo de compilação** está definido como **D3D**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-589">**Build Type** is set to **D3D**</span></span>

    3.  <span data-ttu-id="7a7f6-590">O **SDK** está definido para o **mais recente instalado**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-590">**SDK** is set to **Latest installed**</span></span>

    4.  <span data-ttu-id="7a7f6-591">A **versão do Visual Studio** está definida para o **mais recente instalado**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-591">**Visual Studio Version** is set to **Latest installed**</span></span>

    5.  <span data-ttu-id="7a7f6-592">**Compilar e executar** é definido como **computador local**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-592">**Build and Run** is set to **Local Machine**</span></span>

    6.  <span data-ttu-id="7a7f6-593">Enquanto isso, vale a pena salvar a cena e adicioná-la à compilação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-593">While here, it is worth saving the scene, and adding it to the build.</span></span>

        1. <span data-ttu-id="7a7f6-594">Faça isso selecionando **Adicionar abrir cenas**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-594">Do this by selecting **Add Open Scenes**.</span></span> <span data-ttu-id="7a7f6-595">Uma janela salvar será exibida.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-595">A save window will appear.</span></span>

            ![Adicionar cenas abertas](images/AzureLabs-Lab8-83.png)

        2. <span data-ttu-id="7a7f6-597">Crie uma nova pasta para isso e qualquer cena futura, em seguida, selecione o botão **nova pasta** , para criar uma nova pasta, nomeie-a como **cenas**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-597">Create a new folder for this, and any future, scene, then select the **New folder** button, to create a new folder, name it **Scenes**.</span></span>

            ![nova pasta de cenas](images/AzureLabs-Lab8-84.png)

        3. <span data-ttu-id="7a7f6-599">Abra sua pasta de **cenas** recém-criada e, em seguida, no campo **nome do arquivo:** texto, digite **\_NH Mr\_Scene**e pressione **salvar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-599">Open your newly created **Scenes** folder, and then in the **File name:** text field, type **NH\_MR\_Scene**, then press **Save**.</span></span>

            ![nova cena-NH_MR_Scene](images/AzureLabs-Lab8-85.png)

    7.  <span data-ttu-id="7a7f6-601">As configurações restantes, em **configurações de compilação**, devem ser deixadas como padrão por enquanto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-601">The remaining settings, in **Build Settings**, should be left as default for now.</span></span>

6.  <span data-ttu-id="7a7f6-602">Na mesma janela, clique no botão **configurações do Player** , isso abrirá o painel relacionado no espaço onde o **Inspetor** está localizado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-602">In the same window click on the **Player Settings** button, this will open the related panel in the space where the **Inspector** is located.</span></span>    

    ![abrir configurações do Player](images/AzureLabs-Lab8-86.png)

7.  <span data-ttu-id="7a7f6-604">Nesse painel, algumas configurações precisam ser verificadas:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-604">In this panel, a few settings need to be verified:</span></span>

    1.  <span data-ttu-id="7a7f6-605">Na guia **outras configurações** :</span><span class="sxs-lookup"><span data-stu-id="7a7f6-605">In the **Other Settings** tab:</span></span>

        1.  <span data-ttu-id="7a7f6-606">A **versão de tempo de execução de script** deve ser **Experimental** (.NET 4,6 equivalente)</span><span class="sxs-lookup"><span data-stu-id="7a7f6-606">**Scripting Runtime Version** should be **Experimental** (.NET 4.6 Equivalent)</span></span>
        2.  <span data-ttu-id="7a7f6-607">O **back-end de script** deve ser ***.net***</span><span class="sxs-lookup"><span data-stu-id="7a7f6-607">**Scripting Backend** should be ***.NET***</span></span>
        3.  <span data-ttu-id="7a7f6-608">O **nível de compatibilidade da API** deve ser **.NET 4,6**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-608">**API Compatibility Level** should be **.NET 4.6**</span></span>

            ![compatibilidade de API](images/AzureLabs-Lab8-87.png)

    2.  <span data-ttu-id="7a7f6-610">Mais adiante no painel, em **configurações de XR** (encontradas abaixo de **configurações de publicação**), **suporte à realidade virtual**em escala, verifique se o SDK do **Windows Mixed Reality** foi adicionado</span><span class="sxs-lookup"><span data-stu-id="7a7f6-610">Further down the panel, in **XR Settings** (found below **Publish Settings**), tick **Virtual Reality Supported**, make sure the **Windows Mixed Reality SDK** is added</span></span>

        ![configurações de atualização XR](images/AzureLabs-Lab8-88.png)        

    3.  <span data-ttu-id="7a7f6-612">Na guia **configurações de publicação** , em **recursos**, verificar:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-612">Within the **Publishing Settings** tab, under **Capabilities**, heck:</span></span>

        - <span data-ttu-id="7a7f6-613">**InternetClient**</span><span class="sxs-lookup"><span data-stu-id="7a7f6-613">**InternetClient**</span></span>           

            ![cliente de Internet em escala](images/AzureLabs-Lab8-89.png)

8.  <span data-ttu-id="7a7f6-615">De volta às **configurações de compilação**, os projetos de **Unity C#**  não ficam mais esmaecidos: marque a caixa de seleção ao lado disso.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-615">Back in **Build Settings**, **Unity C# Projects** is no longer greyed out: tick the checkbox next to this.</span></span>

9.  <span data-ttu-id="7a7f6-616">Com essas alterações feitas, feche a janela configurações de compilação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-616">With these changes done, close the Build Settings window.</span></span>

10. <span data-ttu-id="7a7f6-617">Salve sua cena e **arquivo** > de projeto**salvar cena/arquivo** > **salvar projeto**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-617">Save your Scene and Project **File** > **Save Scene / File** > **Save Project**.</span></span>

    > [!IMPORTANT]
    > <span data-ttu-id="7a7f6-618">Se você quiser ignorar o componente de *configuração do Unity* para este projeto (aplicativo de realidade misturada) e continuar diretamente no código, fique à vontade para baixá-lo [. unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-MR.unitypackage), importe-o para seu projeto como um [**pacote personalizado**](https://docs.unity3d.com/Manual/AssetPackages.html)e, em seguida, continue de [ Capítulo 14](#chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-618">If you wish to skip the *Unity Set up* component for this project (mixed reality App), and continue straight into code, feel free to [download this .unitypackage](https://github.com/Microsoft/HolographicAcademy/raw/Azure-MixedReality-Labs/Azure%20Mixed%20Reality%20Labs/MR%20and%20Azure%20308%20-%20Cross-device%20notifications/Azure-MR-308-MR.unitypackage), import it into your project as a [**Custom Package**](https://docs.unity3d.com/Manual/AssetPackages.html), and then continue from [Chapter 14](#chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project).</span></span> <span data-ttu-id="7a7f6-619">Ainda será necessário adicionar os componentes de script.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-619">You will still need to add the script components.</span></span>

### <a name="chapter-13---importing-the-dlls-in-the-mixed-reality-unity-project"></a><span data-ttu-id="7a7f6-620">Capítulo 13-importando as DLLs no projeto de Unity da realidade misturada</span><span class="sxs-lookup"><span data-stu-id="7a7f6-620">Chapter 13 - Importing the DLLs in the Mixed Reality Unity Project</span></span>

<span data-ttu-id="7a7f6-621">Você usará o armazenamento do Azure para biblioteca do Unity (que usa o SDK do .net para Azure).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-621">You will be using Azure Storage for Unity library (which uses the .Net SDK for Azure).</span></span> <span data-ttu-id="7a7f6-622">Siga este [link sobre como usar o armazenamento do Azure com o Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-622">Please follow this [link on how to use Azure Storage with Unity](https://docs.microsoft.com/sandbox/gamedev/unity/azure-storage-unity).</span></span>
<span data-ttu-id="7a7f6-623">Atualmente, há um problema conhecido no Unity que exige que os plugins sejam reconfigurados após a importação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-623">There is currently a known issue in Unity which requires plugins to be reconfigured after import.</span></span> <span data-ttu-id="7a7f6-624">Essas etapas (4-7 nesta seção) não serão mais necessárias depois que o bug for resolvido.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-624">These steps (4 - 7 in this section) will no longer be required after the bug has been resolved.</span></span>

<span data-ttu-id="7a7f6-625">Para importar o SDK para seu próprio projeto, certifique-se de ter baixado o [. unitypackage](https://aka.ms/azstorage-unitysdk)mais recente.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-625">To import the SDK into your own project, make sure you have downloaded the latest [.unitypackage](https://aka.ms/azstorage-unitysdk).</span></span> <span data-ttu-id="7a7f6-626">Em seguida, faça o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-626">Then, do the following:</span></span>

1.  <span data-ttu-id="7a7f6-627">Adicione o. unitypackage que você baixou do, para o Unity usando a opção de menu**pacote personalizado** de**importação** > de **ativos** > .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-627">Add the .unitypackage you downloaded from the above, to Unity by using the **Assets** > **Import Package** > **Custom Package** menu option.</span></span>

2.  <span data-ttu-id="7a7f6-628">Na caixa **Importar pacote de Unity** que aparece, você pode selecionar tudo em**armazenamento**de **plug-in** > .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-628">In the **Import Unity Package** box that pops up, you can select everything under **Plugin** > **Storage**.</span></span>

    ![Importar pacote](images/AzureLabs-Lab8-90.png)

3.  <span data-ttu-id="7a7f6-630">Clique no botão **importar** para adicionar os itens ao seu projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-630">Click the **Import** button to add the items to your project.</span></span>

4.  <span data-ttu-id="7a7f6-631">Vá para a pasta **armazenamento** em **plug-ins** na exibição do projeto e selecione os seguintes plugins *somente*:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-631">Go to the **Storage** folder under **Plugins** in the Project view and select the following plugins *only*:</span></span>

    -   <span data-ttu-id="7a7f6-632">Microsoft.Data.Edm</span><span class="sxs-lookup"><span data-stu-id="7a7f6-632">Microsoft.Data.Edm</span></span>
    -   <span data-ttu-id="7a7f6-633">Microsoft.Data.OData</span><span class="sxs-lookup"><span data-stu-id="7a7f6-633">Microsoft.Data.OData</span></span>
    -   <span data-ttu-id="7a7f6-634">Microsoft. WindowsAzure. Storage</span><span class="sxs-lookup"><span data-stu-id="7a7f6-634">Microsoft.WindowsAzure.Storage</span></span>
    -   <span data-ttu-id="7a7f6-635">Newtonsoft.Json</span><span class="sxs-lookup"><span data-stu-id="7a7f6-635">Newtonsoft.Json</span></span>
    -   <span data-ttu-id="7a7f6-636">System.Spatial</span><span class="sxs-lookup"><span data-stu-id="7a7f6-636">System.Spatial</span></span>

    ![selecionar plug-ins](images/AzureLabs-Lab8-91.png)

5.  <span data-ttu-id="7a7f6-638">Com *esses plugins específicos* selecionados, **desmarque** **qualquer plataforma** e **desmarque** **WSAPlayer** e clique em **aplicar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-638">With *these specific plugins* selected, **uncheck** **Any Platform** and **uncheck** **WSAPlayer** then click **Apply**.</span></span>

    ![aplicar alterações de plataforma](images/AzureLabs-Lab8-92.png)

    > [!NOTE] 
    > <span data-ttu-id="7a7f6-640">Você está marcando esses plugins específicos para serem usados apenas no editor do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-640">You are marking these particular plugins to only be used in the Unity Editor.</span></span> <span data-ttu-id="7a7f6-641">Isso ocorre porque há diferentes versões dos mesmos plug-ins na pasta WSA que serão usados depois que o projeto for exportado do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-641">This is because there are different versions of the same plugins in the WSA folder that will be used after the project is exported from Unity.</span></span>

6.  <span data-ttu-id="7a7f6-642">Na pasta plug-in de **armazenamento** , selecione somente:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-642">In the **Storage** plugin folder, select only:</span></span>

    -   <span data-ttu-id="7a7f6-643">Microsoft. Data. Services. Client</span><span class="sxs-lookup"><span data-stu-id="7a7f6-643">Microsoft.Data.Services.Client</span></span>

        ![selecionar cliente de serviços de dados](images/AzureLabs-Lab8-93.png)

7.  <span data-ttu-id="7a7f6-645">Marque a caixa **não processar** em **configurações da plataforma** e clique em **aplicar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-645">Check the **Don't Process** box under **Platform Settings** and click **Apply**.</span></span>

    ![não processar](images/AzureLabs-Lab8-94.png)

    > [!NOTE] 
    > <span data-ttu-id="7a7f6-647">Você está marcando este plug-in "não processar" porque o assembly do Unity Patcher tem dificuldade para processar esse plug-in.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-647">You are marking this plugin "Don't process" because the Unity assembly patcher has difficulty processing this plugin.</span></span> <span data-ttu-id="7a7f6-648">O plug-in ainda funcionará, embora não seja processado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-648">The plugin will still work even though it isn't processed.</span></span>

## <a name="chapter-14---creating-the-tabletoscene-class-in-the-mixed-reality-unity-project"></a><span data-ttu-id="7a7f6-649">Capítulo 14-criando a classe TableToScene no projeto de Unity de realidade misturada</span><span class="sxs-lookup"><span data-stu-id="7a7f6-649">Chapter 14 - Creating the TableToScene class in the mixed reality Unity project</span></span>

<span data-ttu-id="7a7f6-650">A classe **TableToScene** é idêntica à explicada no [capítulo 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-650">The **TableToScene** class is identical to the one explained in [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span> <span data-ttu-id="7a7f6-651">Crie a mesma classe no projeto de Unity de realidade misturada seguindo o mesmo procedimento explicado no [capítulo 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-651">Create the same class in the mixed reality Unity Project following the same procedure explained in [Chapter 9](#chapter-9---create-the-tabletoscene-class-in-the-desktop-unity-project).</span></span>

<span data-ttu-id="7a7f6-652">Depois de concluir este capítulo, os dois projetos do **Unity** terão essa classe configurada na câmera principal.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-652">Once you have completed this Chapter, both of your **Unity Projects** will have this class set up on the Main Camera.</span></span>

## <a name="chapter-15---creating-the-notificationreceiver-class-in-the-mixed-reality-unity-project"></a><span data-ttu-id="7a7f6-653">Capítulo 15 – criando a classe NotificationReceiver no projeto de Unity de realidade misturada</span><span class="sxs-lookup"><span data-stu-id="7a7f6-653">Chapter 15 - Creating the NotificationReceiver class in the Mixed Reality Unity Project</span></span>

<span data-ttu-id="7a7f6-654">O segundo script que você precisa criar é **NotificationReceiver**, que é responsável por:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-654">The second script you need to create is **NotificationReceiver**, which is responsible for:</span></span>

-   <span data-ttu-id="7a7f6-655">Registrando o aplicativo com o Hub de notificação na inicialização.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-655">Registering the app with the Notification Hub at initialization.</span></span>
-   <span data-ttu-id="7a7f6-656">Escutando notificações provenientes do hub de notificação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-656">Listening to notifications coming from the Notification Hub.</span></span>
-   <span data-ttu-id="7a7f6-657">Desserializando os dados de objeto de notificações recebidas.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-657">Deserializing the object data from received notifications.</span></span>
-   <span data-ttu-id="7a7f6-658">Mova o GameObjects na cena, com base nos dados desserializados.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-658">Move the GameObjects in the scene, based on the deserialized data.</span></span>

<span data-ttu-id="7a7f6-659">Para criar o script **NotificationReceiver** :</span><span class="sxs-lookup"><span data-stu-id="7a7f6-659">To create the **NotificationReceiver** script:</span></span>

1.  <span data-ttu-id="7a7f6-660">Clique com o botão direito do mouse na pasta **scripts** , clique em **criar**, **script C\#** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-660">Right-click inside the **Scripts** folder, click **Create**, **C\# Script**.</span></span> <span data-ttu-id="7a7f6-661">Nomeie o script **NotificationReceiver**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-661">Name the script **NotificationReceiver**.</span></span>

    <span data-ttu-id="7a7f6-662">![criar novo script](images/AzureLabs-Lab8-95.png)
    ![c# nome it NotificationReceiver](images/AzureLabs-Lab8-96.png)</span><span class="sxs-lookup"><span data-stu-id="7a7f6-662">![create new c# script](images/AzureLabs-Lab8-95.png)
![name it NotificationReceiver](images/AzureLabs-Lab8-96.png)</span></span>

2.  <span data-ttu-id="7a7f6-663">Clique duas vezes no script para abri-lo.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-663">Double click on the script to open it.</span></span>

3.  <span data-ttu-id="7a7f6-664">Adicione os seguintes namespaces:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-664">Add the following namespaces:</span></span>
...
4.  <span data-ttu-id="7a7f6-665">Insira as seguintes variáveis:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-665">Insert the following variables:</span></span>
...
5.  <span data-ttu-id="7a7f6-666">Substitua o valor **hubName** pelo nome do serviço do hub de notificação e o valor **hubListenEndpoint** com o valor do ponto de extremidade encontrado na guia políticas de acesso, serviço Hub de notificação do Azure, no portal do Azure (consulte a imagem abaixo).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-666">Substitute the **hubName** value with your Notification Hub Service name, and **hubListenEndpoint** value with the endpoint value found in the Access Policies tab, Azure Notification Hub Service, in the Azure Portal (see image below).</span></span>

    ![Inserir ponto de extremidade de política de hubs de notificação](images/AzureLabs-Lab8-97.png)

6.  <span data-ttu-id="7a7f6-668">Agora, adicione os métodos **Start ()** e **ativo ()** para inicializar a classe.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-668">Now add the **Start()** and **Awake()** methods to initialize the class.</span></span>
...
7.  <span data-ttu-id="7a7f6-669">Adicione o método **WaitForNotification** para permitir que o aplicativo receba notificações da biblioteca do hub de notificação sem conflitar com o thread principal:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-669">Add the **WaitForNotification** method to allow the app to receive notifications from the Notification Hub Library without clashing with the Main Thread:</span></span>
...
8.  <span data-ttu-id="7a7f6-670">O método a seguir, **InitNotificationAsync ()** , registrará o aplicativo com o serviço de Hub de notificação na inicialização.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-670">The following method, **InitNotificationAsync()**, will register the application with the notification Hub Service at initialization.</span></span> <span data-ttu-id="7a7f6-671">O código é comentado, pois o Unity não poderá compilar o projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-671">The code is commented out as Unity will not be able to Build the project.</span></span> <span data-ttu-id="7a7f6-672">Você removerá os comentários quando importar o pacote NuGet de mensagens do Azure no Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-672">You will remove the comments when you import the Azure Messaging Nuget package in Visual Studio.</span></span>
...
9.  <span data-ttu-id="7a7f6-673">O manipulador a seguir **,\_PushNotificationReceived de canal ()** , será disparado sempre que uma notificação for recebida.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-673">The following handler, **Channel\_PushNotificationReceived()**, will be triggered every time a notification is received.</span></span> <span data-ttu-id="7a7f6-674">Ele desserializará a notificação, que será a entidade de tabela do Azure que foi movida no aplicativo da área de trabalho e, em seguida, moverá o gameobject correspondente na cena MR para a mesma posição.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-674">It will deserialize the notification, which will be the Azure Table Entity that has been moved on the Desktop Application, and then move the corresponding GameObject in the MR scene to the same position.</span></span> 
    
    > [!IMPORTANT]
    > <span data-ttu-id="7a7f6-675">O código é comentado porque o código faz referência à biblioteca de mensagens do Azure, que você adicionará depois de criar o projeto do Unity usando o Gerenciador de pacotes NuGet, no Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-675">The code is commented out because the code references the Azure Messaging library, which you will add after building the Unity project using the Nuget Package Manager, within Visual Studio.</span></span> <span data-ttu-id="7a7f6-676">Assim, o projeto do Unity não será capaz de Compilar, a menos que seja comentado. Lembre-se de que, se você criar seu projeto e desejar retornar ao Unity, será necessário **comentar novamente** esse código.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-676">As such, the Unity project will not be able to build, unless it is commented out. Be aware, that should you build your project, and then wish to return to Unity, you will need to **re-comment** that code.</span></span>
...
10. <span data-ttu-id="7a7f6-677">Lembre-se de salvar suas alterações antes de voltar para o editor do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-677">Remember to save your changes before going back to the Unity Editor.</span></span>

11. <span data-ttu-id="7a7f6-678">Clique na **câmera principal** do painel **hierarquia** , para que suas propriedades apareçam no **Inspetor**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-678">Click the **Main Camera** from the **Hierarchy** panel, so that its properties appear in the **Inspector**.</span></span>

12. <span data-ttu-id="7a7f6-679">Com a pasta **scripts** aberta, selecione o script **NotificationReceiver** e arraste-o para a **câmera principal**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-679">With the **Scripts** folder open, select the **NotificationReceiver** script and drag it onto the **Main Camera**.</span></span> <span data-ttu-id="7a7f6-680">O resultado deve ser o seguinte:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-680">The result should be as below:</span></span>

    ![Arraste o script do receptor de notificação para a câmera](images/AzureLabs-Lab8-98.png)

    > [!NOTE]
    > <span data-ttu-id="7a7f6-682">Se estiver desenvolvendo isso para o Microsoft HoloLens, você precisará atualizar o componente da *câmera* da **câmera principal**, para que:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-682">If you are developing this for the Microsoft HoloLens, you will need to update the **Main Camera**'s *Camera* component, so that:</span></span>
    > - <span data-ttu-id="7a7f6-683">Limpar sinalizadores: Cor sólida</span><span class="sxs-lookup"><span data-stu-id="7a7f6-683">Clear Flags: Solid Color</span></span>
    > - <span data-ttu-id="7a7f6-684">Seguindo Preto</span><span class="sxs-lookup"><span data-stu-id="7a7f6-684">Background: Black</span></span>

## <a name="chapter-16---build-the-mixed-reality-project-to-uwp"></a><span data-ttu-id="7a7f6-685">Capítulo 16-criar o projeto de realidade misturada para UWP</span><span class="sxs-lookup"><span data-stu-id="7a7f6-685">Chapter 16 - Build the Mixed Reality Project to UWP</span></span>

<span data-ttu-id="7a7f6-686">Este capítulo é idêntico ao processo de compilação para o projeto anterior.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-686">This Chapter is identical to build process for the previous project.</span></span> <span data-ttu-id="7a7f6-687">Tudo o que é necessário para a seção do Unity deste projeto foi concluído, portanto, é hora de compilá-lo a partir do Unity.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-687">Everything needed for the Unity section of this project has now been completed, so it is time to build it from Unity.</span></span>

1.  <span data-ttu-id="7a7f6-688">Navegue até **configurações de compilação** (**configurações de compilação** de **arquivo** > ).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-688">Navigate to **Build Settings** ( **File** > **Build Settings** ).</span></span>

2.  <span data-ttu-id="7a7f6-689">No menu **configurações de Build** , verifique se os **projetos do Unity C#** \* estão com tiques (o que permitirá que você edite os scripts neste projeto, após a compilação).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-689">From the **Build Settings** menu, ensure **Unity C# Projects**\* is ticked (which will allow you to edit the scripts in this project, after build).</span></span>

3.  <span data-ttu-id="7a7f6-690">Depois que isso for feito, clique em **Compilar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-690">After this is done, click **Build**.</span></span>

    ![Compilar projeto](images/AzureLabs-Lab8-99.png)

4.  <span data-ttu-id="7a7f6-692">Uma janela do **Explorador de arquivos** será Popup, solicitando um local para compilar.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-692">A **File Explorer** window will popup, prompting you for a location to Build.</span></span> <span data-ttu-id="7a7f6-693">Crie uma nova pasta (clicando em **nova pasta** no canto superior esquerdo) e nomeie-a como **Build**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-693">Create a new folder (by clicking **New Folder** in the top-left corner), and name it **BUILDS**.</span></span>

    ![criar pasta de builds](images/AzureLabs-Lab8-100.png)

    1.  <span data-ttu-id="7a7f6-695">Abra a nova pasta builds e crie outra pasta (usando a **nova pasta** mais uma vez) e nomeie-a como **\_aplicativo NH\_Mr**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-695">Open the new **BUILDS** folder, and create another folder (using **New Folder** once more), and name it **NH\_MR\_App**.</span></span>

        ![criar pasta NH_MR_Apps](images/AzureLabs-Lab8-101.png)

    2.  <span data-ttu-id="7a7f6-697">Com o **aplicativo\_NH\_Mr** selecionado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-697">With the **NH\_MR\_App** selected.</span></span> <span data-ttu-id="7a7f6-698">Clique em **Selecionar pasta**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-698">click **Select Folder**.</span></span> <span data-ttu-id="7a7f6-699">O projeto levará um minuto ou mais para ser compilado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-699">The project will take a minute or so to build.</span></span>

5.  <span data-ttu-id="7a7f6-700">Após a compilação, uma janela **Explorador de arquivos** será aberta no local do novo projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-700">Following the build, a **File Explorer** window will open at the location of your new project.</span></span>



## <a name="chapter-17---add-nuget-packages-to-the-unitymrnotifhub-solution"></a><span data-ttu-id="7a7f6-701">Capítulo 17 – adicionar pacotes NuGet à solução UnityMRNotifHub</span><span class="sxs-lookup"><span data-stu-id="7a7f6-701">Chapter 17 - Add NuGet packages to the UnityMRNotifHub Solution</span></span>

> [!WARNING] 
> <span data-ttu-id="7a7f6-702">Lembre-se de que, depois de adicionar os seguintes pacotes do NuGet (e remover o comentário do código no próximo [capítulo](#chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class)), o código, quando reaberto no projeto do Unity, apresentará erros.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-702">Please remember that, once you add the following NuGet Packages (and uncomment the code in the next [Chapter](#chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class)), the Code, when reopened within the Unity Project, will present errors.</span></span> <span data-ttu-id="7a7f6-703">Se desejar voltar e continuar a edição no editor do Unity, você precisará comentar o código errosome e, em seguida, remover o comentário novamente mais tarde, depois de voltar ao Visual Studio.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-703">If you wish to go back and continue editing in the Unity Editor, you will need comment that errosome code, and then uncomment again later, once you are back in Visual Studio.</span></span> 

<span data-ttu-id="7a7f6-704">Após a conclusão da compilação da realidade misturada, navegue até o projeto de realidade misturada, que você criou e clique duas vezes no arquivo da solução (. sln) dentro dessa pasta para abrir sua solução com o Visual Studio 2017.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-704">Once the mixed reality build has been completed, navigate to the mixed reality project, which you built, and double click on the solution (.sln) file within that folder, to open your solution with Visual Studio 2017.</span></span>
<span data-ttu-id="7a7f6-705">Agora, você precisará adicionar o pacote NuGet **WindowsAzure. Messaging. Managed** ; Esta é uma biblioteca que é usada para receber notificações do hub de notificação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-705">You will now need to add the **WindowsAzure.Messaging.managed** NuGet package; this is a library that is used to receive Notifications from the Notification Hub.</span></span>

<span data-ttu-id="7a7f6-706">Para importar o pacote NuGet:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-706">To import the NuGet package:</span></span>

1.  <span data-ttu-id="7a7f6-707">Na **Gerenciador de soluções**, clique com o botão direito do mouse em sua solução</span><span class="sxs-lookup"><span data-stu-id="7a7f6-707">In the **Solution Explorer**, right click on your Solution</span></span>

2.  <span data-ttu-id="7a7f6-708">Clique em **gerenciar pacotes NuGet**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-708">Click on **Manage NuGet Packages**.</span></span>

    ![abrir o Gerenciador do NuGet](images/AzureLabs-Lab8-102.png)

3.  <span data-ttu-id="7a7f6-710">Selecione a guia ***procurar*** e procure **WindowsAzure. Messaging. Managed**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-710">Select the ***Browse*** tab and search for **WindowsAzure.Messaging.managed**.</span></span>

    ![Localizar pacote de mensagens do Windows Azure](images/AzureLabs-Lab8-103.png)

4.  <span data-ttu-id="7a7f6-712">Selecione o resultado (como mostrado abaixo) e, na janela à direita, marque a caixa de seleção ao lado de **projeto**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-712">Select the result (as shown below), and in the window to the right, select the checkbox next to **Project**.</span></span> <span data-ttu-id="7a7f6-713">Isso coloca um tique na caixa de seleção ao lado de **Project**, juntamente com a caixa de seleção ao lado do projeto **assembly-Csharp** e **UnityMRNotifHub** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-713">This will place a tick in the checkbox next to **Project**, along with the checkbox next to the **Assembly-CSharp** and **UnityMRNotifHub** project.</span></span>

    ![todos os projetos em escala](images/AzureLabs-Lab8-104.png)

5.  <span data-ttu-id="7a7f6-715">A versão fornecida inicialmente **pode não** ser compatível com este projeto.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-715">The version initially provided **may not** be compatible with this project.</span></span> <span data-ttu-id="7a7f6-716">Portanto, clique no menu suspenso ao lado de **versão**e clique em **versão 0.1.7.9**, em seguida, clique em **instalar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-716">Therefore, click on the dropdown menu next to **Version**, and click **Version 0.1.7.9**, then click **Install**.</span></span>

6.  <span data-ttu-id="7a7f6-717">Agora você terminou de instalar o pacote NuGet.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-717">You have now finished installing the NuGet package.</span></span> <span data-ttu-id="7a7f6-718">Localize o código comentado que você inseriu na classe **NotificationReceiver** e remova os comentários.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-718">Find the commented code you entered in the **NotificationReceiver** class and remove the comments..</span></span>



## <a name="chapter-18---edit-unitymrnotifhub-application-notificationreceiver-class"></a><span data-ttu-id="7a7f6-719">Capítulo 18-editar aplicativo UnityMRNotifHub, classe NotificationReceiver</span><span class="sxs-lookup"><span data-stu-id="7a7f6-719">Chapter 18 - Edit UnityMRNotifHub application, NotificationReceiver class</span></span>

<span data-ttu-id="7a7f6-720">Depois de ter adicionado os **pacotes NuGet**, você precisará remover o *Comentário* de parte do código dentro da classe **NotificationReceiver** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-720">Following having added the **NuGet Packages**, you will need to *uncomment* some of the code within the **NotificationReceiver** class.</span></span>

<span data-ttu-id="7a7f6-721">Isso inclui:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-721">This includes:</span></span>

1. <span data-ttu-id="7a7f6-722">O namespace na parte superior:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-722">The namespace at the top:</span></span>

    ```csharp
    using Microsoft.WindowsAzure.Messaging;
    ```

2. <span data-ttu-id="7a7f6-723">Todo o código dentro do método **InitNotificationsAsync ()** :</span><span class="sxs-lookup"><span data-stu-id="7a7f6-723">All the code within the **InitNotificationsAsync()** method:</span></span>
...
> [!WARNING]
> <span data-ttu-id="7a7f6-724">O código acima tem um comentário: Certifique-se de que você não tenha desmarcado *acidentalmente esse* comentário (pois o código não será compilado se você tiver!).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-724">The code above has a comment in it: ensure that you have not accidentally *uncommented* that comment (as the code will not compile if you have!).</span></span>

3. <span data-ttu-id="7a7f6-725">E, por fim, o evento **Channel_PushNotificationReceived** :</span><span class="sxs-lookup"><span data-stu-id="7a7f6-725">And, lastly, the **Channel_PushNotificationReceived** event:</span></span>
...
<span data-ttu-id="7a7f6-726">Com esses comentários, certifique-se de salvar e, em seguida, vá para o próximo capítulo.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-726">With these uncommented, ensure that you save, and then proceed to the next Chapter.</span></span>

## <a name="chapter-19---associate-the-mixed-reality-project-to-the-store-app"></a><span data-ttu-id="7a7f6-727">Capítulo 19 – associar o projeto de realidade misturada ao aplicativo da loja</span><span class="sxs-lookup"><span data-stu-id="7a7f6-727">Chapter 19 - Associate the mixed reality project to the Store app</span></span>

<span data-ttu-id="7a7f6-728">Agora você precisa associar o projeto de **realidade misturada** ao aplicativo da loja criado no no início do laboratório.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-728">You now need to associate the **mixed reality** project to the Store App you created in at the start of the lab.</span></span>

1.  <span data-ttu-id="7a7f6-729">Abra a solução.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-729">Open the solution.</span></span>

2.  <span data-ttu-id="7a7f6-730">Clique com o botão direito do mouse no projeto de aplicativo UWP no painel de Gerenciador de Soluções, acesse **armazenar**e **associe o aplicativo à loja...** .</span><span class="sxs-lookup"><span data-stu-id="7a7f6-730">Right click on the UWP app Project in the Solution Explorer panel, the go to **Store**, and **Associate App with the Store...**.</span></span>

    ![abrir Associação de armazenamento](images/AzureLabs-Lab8-105.png)

3.  <span data-ttu-id="7a7f6-732">Uma nova janela será exibida chamada **associar seu aplicativo à Windows Store**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-732">A new window will appear called **Associate Your App with the Windows Store**.</span></span> <span data-ttu-id="7a7f6-733">Clique em **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-733">Click **Next**.</span></span>

    ![ir para a próxima tela](images/AzureLabs-Lab8-106.png)

4.  <span data-ttu-id="7a7f6-735">Ele carregará todos os aplicativos associados à conta em que você fez logon.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-735">It will load up all the Applications associated with the Account which you have logged in.</span></span> <span data-ttu-id="7a7f6-736">Se você não estiver conectado à sua conta, poderá **fazer logon** nesta página.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-736">If you are not logged in to your account, you can **Log In** on this page.</span></span>

5.  <span data-ttu-id="7a7f6-737">Localize o **nome do aplicativo da loja** que você criou no início deste tutorial e selecione-o.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-737">Find the **Store App name** that you created at the start of this tutorial and select it.</span></span> <span data-ttu-id="7a7f6-738">Clique em **Avançar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-738">Then click **Next**.</span></span>

    ![Localizar e selecionar o nome do repositório](images/AzureLabs-Lab8-107.png)

6.  <span data-ttu-id="7a7f6-740">Clique em **associar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-740">Click **Associate**.</span></span>

    ![associar o aplicativo](images/AzureLabs-Lab8-108.png)

7.  <span data-ttu-id="7a7f6-742">Seu aplicativo agora está **associado** ao aplicativo da loja.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-742">Your App is now **Associated** with the Store App.</span></span> <span data-ttu-id="7a7f6-743">Isso é necessário para habilitar as notificações.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-743">This is necessary for enabling Notifications.</span></span>

## <a name="chapter-20---deploy-unitymrnotifhub-and-unitydesktopnotifhub-applications"></a><span data-ttu-id="7a7f6-744">Capítulo 20-implantar aplicativos UnityMRNotifHub e UnityDesktopNotifHub</span><span class="sxs-lookup"><span data-stu-id="7a7f6-744">Chapter 20 - Deploy UnityMRNotifHub and UnityDesktopNotifHub applications</span></span>

<span data-ttu-id="7a7f6-745">Este capítulo pode ser mais fácil com duas pessoas, pois o resultado incluirá ambos os aplicativos em execução, um em execução na área de trabalho do computador e o outro no headset de imersão.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-745">This Chapter may be easier with two people, as the result will include both apps running, one running on your computer Desktop, and the other within your immersive headset.</span></span>

<span data-ttu-id="7a7f6-746">O aplicativo de headset de imersão está aguardando para receber alterações na cena (alterações de posição do GameObjects local) e o aplicativo de área de trabalho fará alterações em sua cena local (alterações de posição), que será compartilhada para o aplicativo MR.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-746">The immersive headset app is waiting to receive changes to the scene (position changes of the local GameObjects), and the Desktop app will be making changes to their local scene (position changes), which will be shared to the MR app.</span></span> <span data-ttu-id="7a7f6-747">Faz sentido implantar o aplicativo Sr primeiro, seguido pelo aplicativo de desktop, para que o receptor possa começar a escutar.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-747">It makes sense to deploy the MR app first, followed by the Desktop app, so that the receiver can begin listening.</span></span>

<span data-ttu-id="7a7f6-748">Para implantar o aplicativo **UnityMRNotifHub** em seu computador local:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-748">To deploy the **UnityMRNotifHub** app on your Local Machine:</span></span>

1.  <span data-ttu-id="7a7f6-749">Abra o arquivo de solução do seu aplicativo **UnityMRNotifHub** no **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-749">Open the solution file of your **UnityMRNotifHub** app in **Visual Studio 2017**.</span></span>

2.  <span data-ttu-id="7a7f6-750">Na **plataforma da solução**, selecione **x86, computador local**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-750">In the **Solution Platform**, select **x86, Local Machine**.</span></span>

3.  <span data-ttu-id="7a7f6-751">Na **configuração da solução** , selecione **depurar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-751">In the **Solution Configuration** select **Debug**.</span></span>

    ![definir configuração do projeto](images/AzureLabs-Lab8-109.png)

4.  <span data-ttu-id="7a7f6-753">Vá para o **menu Compilar** e clique em **implantar solução** para Sideload o aplicativo em seu computador.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-753">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span>

5.  <span data-ttu-id="7a7f6-754">Seu aplicativo agora deve aparecer na lista de aplicativos instalados, pronto para ser iniciado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-754">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

<span data-ttu-id="7a7f6-755">Para implantar o aplicativo **UnityDesktopNotifHub** no computador local:</span><span class="sxs-lookup"><span data-stu-id="7a7f6-755">To deploy the **UnityDesktopNotifHub** app on Local Machine:</span></span>

1.  <span data-ttu-id="7a7f6-756">Abra o arquivo de solução do seu aplicativo **UnityDesktopNotifHub** no **Visual Studio 2017**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-756">Open the solution file of your **UnityDesktopNotifHub** app in **Visual Studio 2017**.</span></span>

2.  <span data-ttu-id="7a7f6-757">Na **plataforma da solução**, selecione **x86, computador local**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-757">In the **Solution Platform**, select **x86, Local Machine**.</span></span>

3.  <span data-ttu-id="7a7f6-758">Na **configuração da solução** , selecione **depurar**.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-758">In the **Solution Configuration** select **Debug**.</span></span>

    ![definir configuração do projeto](images/AzureLabs-Lab8-110.png)

4.  <span data-ttu-id="7a7f6-760">Vá para o **menu Compilar** e clique em **implantar solução** para Sideload o aplicativo em seu computador.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-760">Go to **Build menu** and click on **Deploy Solution** to sideload the application to your machine.</span></span>

5.  <span data-ttu-id="7a7f6-761">Seu aplicativo agora deve aparecer na lista de aplicativos instalados, pronto para ser iniciado.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-761">Your App should now appear in the list of installed apps, ready to be launched.</span></span>

6.  <span data-ttu-id="7a7f6-762">Inicie o aplicativo de realidade misturada, seguido pelo aplicativo de desktop.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-762">Launch the mixed reality application, followed by the Desktop application.</span></span>

<span data-ttu-id="7a7f6-763">Com ambos os aplicativos em execução, mova um objeto na cena da área de trabalho (usando o botão esquerdo do mouse).</span><span class="sxs-lookup"><span data-stu-id="7a7f6-763">With both applications running, move an object in the desktop scene (using the Left Mouse Button).</span></span> <span data-ttu-id="7a7f6-764">Essas alterações posicionais serão feitas localmente, serializadas e enviadas para o serviço de Aplicativo de funções.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-764">These positional changes will be made locally, serialized, and sent to the Function App service.</span></span> <span data-ttu-id="7a7f6-765">O serviço de Aplicativo de funções atualizará a tabela junto com o Hub de notificação.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-765">The Function App service will then update the Table along with the Notification Hub.</span></span> <span data-ttu-id="7a7f6-766">Após ter recebido uma atualização, o Hub de notificação enviará os dados atualizados diretamente para todos os aplicativos registrados (nesse caso, o aplicativo de headsets de imersão), que desserializará os dados de entrada e aplicará os novos dados posicionais aos objetos locais, movendo-os em cena.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-766">Having received an update, the Notification Hub will send the updated data directly to all the registered applications (in this case the immersive headset app), which will then deserialize the incoming data, and apply the new positional data to the local objects, moving them in scene.</span></span>


## <a name="your-finished-your-azure-notification-hubs-application"></a><span data-ttu-id="7a7f6-767">Seu aplicativo de hubs de notificação do Azure foi concluído</span><span class="sxs-lookup"><span data-stu-id="7a7f6-767">Your finished your Azure Notification Hubs application</span></span>
 
<span data-ttu-id="7a7f6-768">Parabéns, você criou um aplicativo de realidade misturada que aproveita o serviço de hubs de notificação do Azure e permite a comunicação entre aplicativos.</span><span class="sxs-lookup"><span data-stu-id="7a7f6-768">Congratulations, you built a mixed reality app that leverages the Azure Notification Hubs Service and allow communication between apps.</span></span>
 
![final do produto final](images/AzureLabs-Lab8-00.png)
 
## <a name="bonus-exercises"></a><span data-ttu-id="7a7f6-770">Exercícios de bônus</span><span class="sxs-lookup"><span data-stu-id="7a7f6-770">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="7a7f6-771">Exercício 1</span><span class="sxs-lookup"><span data-stu-id="7a7f6-771">Exercise 1</span></span>

<span data-ttu-id="7a7f6-772">Você pode solucionar como alterar a cor do GameObjects e enviar essa notificação para outros aplicativos que visualizam a cena?</span><span class="sxs-lookup"><span data-stu-id="7a7f6-772">Can you work out how to change the color of the GameObjects and send that notification to other apps viewing the scene?</span></span>

### <a name="exercise-2"></a><span data-ttu-id="7a7f6-773">Exercício 2</span><span class="sxs-lookup"><span data-stu-id="7a7f6-773">Exercise 2</span></span>

<span data-ttu-id="7a7f6-774">Você pode adicionar movimento do GameObjects ao seu aplicativo MR e ver a cena atualizada em seu aplicativo de desktop?</span><span class="sxs-lookup"><span data-stu-id="7a7f6-774">Can you add movement of the GameObjects to your MR app and see the updated scene in your desktop app?</span></span>
