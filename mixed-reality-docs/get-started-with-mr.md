...
:::row:::
    :::column:::
       [![Não estou familiarizado com a realidade misturada](images/Tile-New.jpg)](get-started-with-mr.md#understand-the-basics)<br>
        **[Não estou familiarizado com a realidade misturada](get-started-with-mr.md#understand-the-basics)**<br>
        Noções básicas
    :::column-end:::
    :::column:::
       [![Sou designer](images/Tile-Create.jpg)](design.md)<br>
        **[Sou designer](design.md)**<br>
        Comece a projetar e a criar protótipos
    :::column-end:::
    :::column:::
       [![Sou um desenvolvedor](images/Tile-Develop.jpg)](development.md)<br>
        **[Sou um desenvolvedor](development.md)**<br>
        Conheça as ferramentas e a arquitetura
    :::column-end:::
    :::column:::
       [![Comece a usar o Unity e o MRTK](images/Tile-JumpIn.jpg)](https://microsoft.github.io/MixedRealityToolkit-Unity/Documentation/GettingStartedWithTheMRTK.html)<br>
        **[Comece a usar o Unity e o MRTK](https://microsoft.github.io/MixedRealityToolkit-Unity/Documentation/GettingStartedWithTheMRTK.html)**<br>
        Otimizar o Unity para o desenvolvimento em MR
    :::column-end:::
:::row-end:::
